<?php
	// require_once( ABSPATH . 'wp_content/plugins/customized_plugins/Database_Handler/ActivitiesHandler.php');
 // require '../wp_content/plugins/customized_plugins/Database_Handler/ActivitiesHandler.php';
 // $activities = new ActivitiesHandler();
 // if (isset($_GET["activity"]) && is_string($_GET["activity"])) {
	// 	$activities->delete_activity($_GET["activity"]);
	// }
...
require_once( ABSPATH . 'wp-content/plugins/customized-plugins/Database_Handler/ActivitiesHandler.php');
$activities = new ActivitiesHandler();
 if (isset($_GET["activity"]) && is_string($_GET["activity"])) {
		$activities->delete_activity($_GET["activity"]);
	}
 if (isset($_GET["interest"]) && is_string($_GET["interest"])) {
		$activities->delete_activity_interest($_GET["interest"]);
	}
