<?php
    ...
    if(isset($_POST['submit'])){
    	...
    	if (move_uploaded_file($_FILES['image_upload']['tmp_name'], $target_path)) {
    		$InsertUser->register($_POST['firstName'],$_POST['lastName'],$_POST['email'],$_POST['phone'],$_POST['gender'],md5($_POST['password']),$_POST['country'],$_POST['city'],$target_path,$interest);	
    	}
      }
?>
